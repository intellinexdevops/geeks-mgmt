...
<body class="font-sans antialiased bg-gray-700 dark:bg-black dark:text-white/50 flex-col"
    style="width: 100%; height: 100vh; display: flex; align-items: center; justify-content:center;">
    <div class="text-white/50 text-2xl font-semibold dark:bg-black dark:text-white/50">
        Geeks Admin Control Panel
    </div>
